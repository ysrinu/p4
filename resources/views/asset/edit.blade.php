            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="group_id">
                        ...
                        <option value="{{ $key }}" {{ $result->group->id === $key ? 'selected="selected"' : '' }}>{{ $val }}</option>
                        @endforeach
                        @endif
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="location_id">
                        ...
                        <option value="{{ $key }}" {{ $result->location->id === $key ? 'selected="selected"' : '' }}>{{ $val }}</option>
                        @endforeach
                        @endif
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="warranty_id">
                        ...
                        <option value="{{ $key }}" {{ $result->warranty->id === $key ? 'selected="selected"' : '' }}>{{ $val }}</option>
                        @endforeach
                        @endif
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="vendor_id">
                        ...
                        <option value="{{ $key }}" {{ $result->vendor->id === $key ? 'selected="selected"' : '' }}>{{ $val }}</option>
                        @endforeach
                        @endif
                    </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="out_of_service_id">
                                ...
                                <option value="{{ $key }}" {{ (isset($result->outofservicecode->id) && $result->outofservicecode->id === $key) ? 'selected="selected"' : '' }}>{{ $val }}</option>
                                @endforeach
                                @endif
                            </select>
