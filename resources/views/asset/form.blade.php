    ...
    <div class="col-sm-10">
        <div class="form-check">
            <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name='is_out_of_service' id='is_out_of_service' onchange="showOutofserviceForm()" {{ old('is_out_of_service', $asset->is_out_of_service) ? 'CHECKED' : '' }}>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="form-check">
            <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name='is_computer' id='is_computer' onchange="showComputerForm()" {{ old('is_computer', $asset->is_computer) ? 'CHECKED' : '' }}>
