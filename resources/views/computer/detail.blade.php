...
<dl class="row">
    ...
    <dt class="col-sm-3">Computer Type Id</dt>
    <dd class="col-sm-9"><a href="{{ URL::to('computertype/'. $computer->computer_type_id) }}" target="_blank">{{ $computer->computer_type_id }}</a></dd>
